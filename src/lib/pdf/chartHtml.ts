...
<div class="print-bar no-print" style="display:flex">
  <div>
    <span class="logo-text">🪐 VEDAANSH</span>
...
<div class="page">
  ...
  <div class="page-footer">
    <span>Vedaansh Jyotish Platform — vedaansh.com</span>
    <span>Page 1</span>
  </div>
</div>
...
<div class="page">
  ...
  <div style="margin-top:32px;padding:16px;background:#f9f9f9;border-left:3px solid #2e6da4;border-radius:2px">
    <p style="font-size:11px;color:#555;line-height:1.7">
      <strong>Disclaimer:</strong> This report is generated by Vedaansh using Swiss Ephemeris (swisseph) 
      ...
      Generated on ${generatedAt} at vedaansh.com.
    </p>
  </div>

  <div class="page-footer">
    <span>Vedaansh Jyotish Platform — vedaansh.com</span>
    <span>Page 5 · © ${new Date().getFullYear()} Vedaansh</span>
  </div>
</div>
