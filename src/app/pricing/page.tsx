...
const FEATURES = {
  kala: {
    ...
    features: [
      ...
      '✓ D1 Rashi + D9 Navamsha + D60',
      '✓ Vimśottarī Daśā (6 levels)',
      '✓ Yoginī & Chara Daśā',
      '✓ Ṣaḍbala planetary strength',
      '✓ All 12 Āruḍha Lagnas',
      '✓ Graha Yogas detection',
      '✓ Aṣṭakavarga (SAV + BAV)',
      '✓ Daily & Monthly Pañcāṅga',
      '✓ Muhūrta finder',
      '✓ Varṣaphal (Solar Return)',
  ...
  vela: {
    ...
    features: [
      ...
      '✓ Priority ephemeris cache',
      '✓ Aṣṭakūṭa Gun Milan (36-pt)',
      '✓ Ashtottarī Daśā',
      '✓ Download charts as PDF',
      '✓ Batch chart calculation',
      '✓ Email chart reports',
      '✓ Advanced Muhūrta filters',
  ...
  hora: {
    ...
    features: [
      ...
      '✓ All Daśā systems (30+)',
      '✓ Unlimited chart saves',
      '✓ White-label chart sharing',
      '✓ Client management dashboard',
      '✓ Bulk PDF export',
      '✓ API access (10,000 req/day)',
      '✓ Priority support',
      '✓ Early access to new features',
      '✓ Custom ayanamsha settings',
    ],
  },
}
