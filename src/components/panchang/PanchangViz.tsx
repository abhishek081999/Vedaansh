...
export function PanchangViz({
  ...
  paksha: string
  yogaPercent: number
  /** 1–27 from pañcāṅga (for legend); wheel uses (Sun+Moon) λ. */
  yogaNumber: number
  sunrise: string
  sunset: string
  tz: string
  ...
  /* Daylight semicircle below wheel — local coords origin at (CX, dayCy) */
  const dayR = 72
  const dayCy = 288
  ...
  return (
    <section className={styles.wrap} aria-label="Pañcāṅga sky diagram">
      <div className={styles.header}>
        <h2 className={styles.title}>Sky wheel — Sun, Moon & limbs</h2>
        ...
        <div className={styles.body}>
          <div className={styles.svgWrap}>
            <svg key={dateStr} viewBox="0 0 400 400" role="img" aria-label="Sidereal ecliptic wheel with Sun and Moon">
              ...
              {/* Rāśī cusp ticks (under thick arcs so they stay subtle) */}
              ...
              {/* Labels on top of thick arcs (avoids “bar” through rāśī text) */}
          ...
          <div className={styles.legend}>
            ...
            <div className={styles.legendRow}>
              ...
              <span>
                ...
                (today only) is local daytime: where “now” falls between sunrise and sunset — not the Sun’s place on the
                zodiac.
              </span>
            </div>
            {dayProgress != null && (
