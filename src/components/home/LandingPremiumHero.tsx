...
import { LandingProductMockup, type MockupSlideId } from '@/components/home/LandingProductMockup'
...
export function LandingPremiumHero({
  ...
  return (
    <section
      className={`landing-premium-hero landing-premium-hero-carousel fade-up ${paused ? 'is-paused' : ''} ${reducedMotion ? 'reduced-motion' : ''}`}
      style={{ ['--hero-auto-ms' as string]: `${AUTO_MS}ms`, ['--hero-accent' as string]: slide.accent }}
    ...
    >
      ...
      <div className="landing-premium-hero-carousel-inner">
        ...
        <div className="landing-hero-carousel-stage landing-premium-hero-stage">
          <article
            key={slide.id}
            className={`landing-premium-hero-slide is-active ${directionClass}`}
          ...
          >
            ...
            <div className="landing-premium-hero-copy">
              ...
              <h1 className="landing-premium-hero-title landing-hero-carousel-title">{slide.title}</h1>
              <p className="landing-premium-hero-desc landing-hero-carousel-desc">{slide.desc}</p>
              ...
              <div className="landing-premium-hero-ctas landing-hero-carousel-cta">
                {slide.cta.action ? (
                  <button
                    type="button"
                    className="btn btn-primary landing-premium-hero-primary landing-hero-carousel-primary"
                ...
                {showMyChart && slide.id === 'astrology' ? (
                  <button
                    type="button"
              ...
              <div className="landing-premium-hero-trust">
                <span>Swiss Ephemeris</span>
                <span className="landing-premium-hero-trust-dot" aria-hidden />
            ...
            <aside className="landing-premium-hero-visual">
              <LandingProductMockup slideId={slide.id} accent={slide.accent} />
            </aside>
          </article>
        </div>
