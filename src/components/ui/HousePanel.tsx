...
export function HousePanel({ chart }: { chart: ChartOutput }) {
  ...
  const isWholeSign = houseSystem === 'whole_sign'
  ...
  return (
    <div className="fade-up" style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
      <div style={{ 
        ...
        <div>
          <div className="label-caps" style={{ color: 'var(--text-gold)', marginBottom: '0.4rem', fontSize: '0.65rem' }}>House Cusps & Bhavas</div>
          ...
          <p style={{ margin: '0.5rem 0 0', fontSize: '0.9rem', color: 'var(--text-muted)', maxWidth: '600px', lineHeight: 1.5 }}>
            Detailed breakdown of house starting points (cusps), their zodiacal placements, 
            ruling lords, and the celestial bodies currently residing within each bhava.
          </p>
        </div>
        ...
        <div style={{ display: 'flex', gap: '0.75rem', flexWrap: 'wrap' }}>
          ...
          <div style={{ 
            ...
            <span style={{ fontSize: '0.7rem', color: 'var(--text-muted)', fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.05em' }}>Calculation System</span>
            <div style={{ width: 1, height: 14, background: 'var(--border-soft)' }} />
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.85rem' }}>
            <thead>
              <tr style={{ background: 'var(--surface-2)', borderBottom: '1px solid var(--border-soft)' }}>
                ...
                <th style={{ padding: '0.85rem 1rem', textAlign: 'left', fontWeight: 600, color: 'var(--text-muted)', textTransform: 'uppercase', fontSize: '0.65rem' }}>Nakṣatra (Cusp)</th>
